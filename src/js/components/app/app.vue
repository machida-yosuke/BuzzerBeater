<template lang="pug">
  .app-wrap(v-bind:style='[backgroundColor, {background}]')
    .app-wrap__megaphone
      <svg v-bind:data-color='megaphoneColor' version="1.1" id="レイヤー_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 779.6 1380" style="enable-background:new 0 0 779.6 1380;" xml:space="preserve">
      <g>
